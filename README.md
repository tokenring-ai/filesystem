...
- When matches are few: Returns grep-style snippets with line numbers (format:
...
**Handler:**
`getContextItems({input, attachments, chatConfig, sourceConfig, agent}: ContextHandlerOptions): AsyncGenerator<ContextItem>`
