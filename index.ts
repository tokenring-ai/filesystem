// TypeScript declaration source for @token-ring/filesystem
// This file provides types via .ts (not .d.ts) while keeping JS runtime implementations.

import type { Service, Resource, Registry } from "@token-ring/registry";

export declare const name: string;
export declare const description: string;
export declare const version: string;

// Re-export namespaces for consumers; runtime provided by index.js
export * as chatCommands from "./chatCommands.js";
export * as tools from "./tools.js";

export declare class FileSystemService extends Service {
...
export declare class FileMatchResource extends Resource {
  constructor(params: {
    items: Array<{
      path: string;
      include?: RegExp;
